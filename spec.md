...
summary: The tabular diff format is a format for expressing the difference
...
match `REMOTE`. For the tabular diff format, we can express the
...
The tabular diff uses the following encoding:
